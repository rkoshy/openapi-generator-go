...
${GOBINS}/${.NAME}:  $(shell find . -name '*.go') go.*
	...
	go install -tags 'osusergo netgo' -v -ldflags "\
		-X github.com/rkoshy/openapi-generator-go/v2/cmd/openapi-generator-go/cmd.GitCommit=$(GIT_COMMIT) \
		-X github.com/rkoshy/openapi-generator-go/v2/cmd/openapi-generator-go/cmd.Version=$(GIT_VERSION)" \
		.
